...
def normalize_facet(facet, facet_type=None, parent_id=None):
    ...
    state_facet = is_state_facet(facet)
...
def is_state_facet(facet):
    return facet.get("id", "").startswith("holds(")
